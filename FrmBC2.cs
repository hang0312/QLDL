...
namespace QuanLyCongTyDuLich
{
    public partial class FrmBC2 : Form
    {
        ...
        private void btnHienThiBC2_Click(object sender, EventArgs e)
        {
            ...
            sql = "(SELECT d.MaLichTour, DangKiTour.NgayDangKy,d.TongTienLichTour FROM DangKiTour inner join " +
                "(SELECT  b.MaLichTour ,SUM(a.DonGia * c.SoLuongDangKy) as TongTienLichTour " +
                  "FROM DanhMucTour as a " +
                  "inner join LichTour as b on a.MaTour = b.MaTour " +
                  "inner join DangKiTour as c on b.MaLichTour = c.MaLichTour " +
                  "GROUP BY  b.MaLichTour) as d ON DangKiTour.MaLichTour = d.MaLichTour " +
                  "WHERE 1=1 ";
            ...
            sql = "SELECT CongTy.MaCongTy, CongTy.TenCongTy, g.DoanhThu " +
                   "FROM CongTy " +
                   "inner join(SELECT DanhMucTour.MaCongTy, SUM(f.TongTienTour) as DoanhThu " +
                                "FROM DanhMucTour " +
                                ...
                                "ON DanhMucTour.MaTour = f.MaTour " +
                                "GROUP BY DanhMucTour.MaCongTy) as g " +
                    "ON CongTy.MaCongTy = g.MaCongTy ";
